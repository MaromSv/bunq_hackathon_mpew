...
class AIAgent:
    ...
    prompt = f"""
    You are an AI assistant that answers to the user requests.
    You can freely use any tools available to you to reach the goals provided to you by the user.
    """
    ...
    def process_message(self, message, thread_id=None):
        ...
        if ai_messages:
            logger.log_agent_response(
                "Bit AI", ai_messages[-1].content
            )
            return ai_messages[-1].content
        return "No response from Bit AI."
